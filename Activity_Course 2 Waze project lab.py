...
# Look at the data, perform EDA and find key variables for the situation.
...
#Question1: There are no missing values in the first ten rows.
#Question2: There are object, float64 and int64 data types. 14,999 rows and 13 columns.
#Question3: 'label' column has 700 missing values.
...
# ==> ENTER YOUR RESPONSE HERE
#The averages and the differences between numbers are pretty much the same in both groups.
...
# ==> ENTER YOUR RESPONSE HERE
#447 were Iphones, 253 were Androids.
...
#Question1: 700 missing values under 'label'. Couldn't find a pattern/reason for the missing values.
#Question2: It's so outliers don't interfere. A median will remain the same dispite outliers.
#Question3: Yes. I would like to know what the frequency of the data collection is because of the difference between the lowest, median and highest distance travelled.
#Question4: Iphone: 64%. Android: 36%.
#Question5: Users who churned used the app more, they also drove further in fewer days.
#Question6: No, there are no outstanding points of data to say churn is correlated to device choice.
